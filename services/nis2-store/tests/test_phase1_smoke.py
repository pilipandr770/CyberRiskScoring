...
# Note: there used to be a test_stripe_webhook_updates_subscription here.
# Stripe was fully removed this session (payments/routes.py gutted, no more
# webhook route, no tiers) — access is insurer-gated only now, so there's
# nothing left for a subscription webhook to test.
